package com.forest.propertymanagement.controller;

import com.forest.propertymanagement.entity.Forest_carmessage;
import com.forest.propertymanagement.entity.Forest_repairrequest;
import com.forest.propertymanagement.global.Forest_variable;
import com.forest.propertymanagement.service.Forest_repairrequestService;
...
public class Forest_fileUploadController {
    ...
    public Map fileUpload(@RequestParam MultipartFile file,String carID, HttpServletRequest request){
        ...
        if(!file.isEmpty()){
            ...
            String savePath = "C:\\Users\\1\\IdeaProjects\\propertymanagement\\src\\main\\resources\\static\\assets\\car";
